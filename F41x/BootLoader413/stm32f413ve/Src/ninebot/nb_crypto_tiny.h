/**
 * @file nb_crypto_tiny.h
 * @author Segway Insight 
 * @brief NB_CRYPTO_TINY 加密解密算法，NB_CRYPTO_TINY 加密解密算法打包lib，提供调用接口
...
#ifndef _NB_CRYPTO_TINY_H_
#define _NB_CRYPTO_TINY_H_
...
/**
 * @brief Ninebot NB_CRYPTO_TINY 加密算法
 * 
 * @param plain			明文数据指针
...
/**
 * @brief Ninebot NB_CRYPTO_TINY 解密算法
 * 
 * @param cipher		密文数据指针
