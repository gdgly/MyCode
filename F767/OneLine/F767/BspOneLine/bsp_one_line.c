...
#define TX_PIN_H    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_SET)
#define TX_PIN_L    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_RESET)

#define RX_PIN  HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_9)
