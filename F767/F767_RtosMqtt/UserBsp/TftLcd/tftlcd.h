...
void LCD_Fill(uint16_t xState, uint16_t yState, uint16_t xEnd, uint16_t yEnd, uint16_t color);  //在指定区域内填充单个颜色

void LCD_DrawPoint(uint16_t x, uint16_t y, uint16_t color);       //快速画点
...
void LCD_Draw_Circle(uint16_t x0, uint16_t y0, uint8_t r, uint16_t color);              //在指定位置画一个指定大小的圆
...
void LCD_ShowNum(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, uint32_t num, uint8_t len, uint8_t size);    //显示数字,高位为0,则不显示

void LCD_ShowxNum(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, uint32_t num, uint8_t len, uint8_t size, uint8_t mode); //显示数字,高位为0,还是显示

void LCD_ShowString(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, uint16_t width, uint16_t height, uint8_t size, uint8_t *p); //显示字符串

void LCD_ShowFontHZ_32(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, uint8_t *cn);                  //显示汉字

void LCD_ShowPicture(uint16_t x, uint16_t y, uint16_t wide, uint16_t high, const unsigned char *pic);   //图片显示
